...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.firewall.map.context.logout' => 'getSecurity_Firewall_Map_Context_LogoutService',
            ...
            'sha256salted_encoder' => 'getSha256saltedEncoderService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Applications/MAMP/htdocs/symfony/app/cache/test/annotations', true);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_af3e3560a88347f4a87b402fe5a6cfd3c3009381fc058fe5cc6708b270f6eed6');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_af3e3560a88347f4a87b402fe5a6cfd3c3009381fc058fe5cc6708b270f6eed6');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_af3e3560a88347f4a87b402fe5a6cfd3c3009381fc058fe5cc6708b270f6eed6');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Applications/MAMP/htdocs/symfony/src/Users/ManagementBundle/Entity')), 'Users\\ManagementBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('UsersManagementBundle' => 'Users\\ManagementBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/Applications/MAMP/htdocs/symfony/app/cache/test/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Applications/MAMP/htdocs/symfony/app/logs/test.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Applications/MAMP/htdocs/symfony/app/cache/test/profiler', '', '', 86400), $a);
    ...
    {
        $a = $this->get('sha256salted_encoder');

        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Users\\ManagementBundle\\Entity\\User' => $a, 'Users\\ManagementBundle\\Entity\\UserTest' => $a));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'), 'security.firewall.map.context.logout' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/logout$'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/dashboard'))), $this->get('debug.event_dispatcher'));
    }
    ...
    {
        return $this->services['security.firewall.map.context.logout'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $k = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($j, array('always_use_default_target_path' => true, 'default_target_path' => '/dashboard', 'use_referer' => true, 'login_path' => 'user_login', 'target_path_parameter' => '_target_path'));
        $k->setProviderKey('secured_area');

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.main'), 1 => $i), 'secured_area', $a, $c), 2 => new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $j, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($j, 'user_login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'user_logout')), 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'secured_area', $k, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $j, array('failure_path' => 'user_login', 'login_path' => 'user_login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $h, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $j, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $j, 'user_login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Applications/MAMP/htdocs/symfony/app/cache/test/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Applications/MAMP/htdocs/symfony/app/cache/test/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    /**
     * Gets the 'sha256salted_encoder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Users\ManagementBundle\Helper\Sha256SaltedHelper A Users\ManagementBundle\Helper\Sha256SaltedHelper instance.
     */
    protected function getSha256saltedEncoderService()
    {
        return $this->services['sha256salted_encoder'] = new \Users\ManagementBundle\Helper\Sha256SaltedHelper();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/MAMP/htdocs/symfony/src/Users/ManagementBundle/Resources/views', 'UsersManagement');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('108d7871e0be2a436fcc377f3fae80847');
    }
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Applications/MAMP/htdocs/symfony/app/cache/test/assetic/assets');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Users\\ManagementBundle\\Entity\\User', 'email', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Applications/MAMP/htdocs/symfony/app/cache/test');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/symfony/app/cache/test',
            ...
            'kernel.bundles' => array(
                ...
                'UsersManagementBundle' => 'Users\\ManagementBundle\\UsersManagementBundle',
            ...
            'locale' => 'en',
            'secret' => '108d7871e0be2a436fcc377f3fae80847',
            ...
            'debug.container.dump' => '/Applications/MAMP/htdocs/symfony/app/cache/test/appTestDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '108d7871e0be2a436fcc377f3fae80847',
            ...
            'session.save_path' => '/Applications/MAMP/htdocs/symfony/app/cache/test/sessions',
            ...
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => '/Applications/MAMP/htdocs/symfony/src/Users/ManagementBundle/Resources/config/validation.yml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/Applications/MAMP/htdocs/symfony/app/cache/test/profiler',
            ...
            'router.resource' => '/Applications/MAMP/htdocs/symfony/app/cache/test/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Applications/MAMP/htdocs/symfony/app/cache/test/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'joan.villariaza@chromedia.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'gelrianz4ever',
            'swiftmailer.mailer.default.transport.smtp.auth_mode' => 'login',
            'swiftmailer.mailer.default.transport.smtp.timeout' => 30,
            'swiftmailer.mailer.default.transport.smtp.source_ip' => NULL,
            'swiftmailer.spool.default.memory.path' => '/Applications/MAMP/htdocs/symfony/app/cache/test/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Applications/MAMP/htdocs/symfony/app/cache/test/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/MAMP/htdocs/symfony/app/cache/test/doctrine/orm/Proxies',
