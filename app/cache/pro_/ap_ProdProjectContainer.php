...
class ap_ProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_f64173a447e82d3a50562c90fad4df5431f41c3d09ee8343886fc56f4c30c97e');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_f64173a447e82d3a50562c90fad4df5431f41c3d09ee8343886fc56f4c30c97e');
        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_f64173a447e82d3a50562c90fad4df5431f41c3d09ee8343886fc56f4c30c97e');
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/Applications/MAMP/htdocs/symfony/src/BugTracker/SampleBundle/Entity', 1 => '/Applications/MAMP/htdocs/symfony/src/Users/ManagementBundle/Entity'));
        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'BugTracker\\SampleBundle\\Entity');
        $f->addDriver($e, 'Users\\ManagementBundle\\Entity');
        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('BugTrackerSampleBundle' => 'BugTracker\\SampleBundle\\Entity', 'UsersManagementBundle' => 'Users\\ManagementBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('/Applications/MAMP/htdocs/symfony/app/cache/pro_/doctrine/orm/Proxies');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Users\\ManagementBundle\\Entity\\User' => $this->get('sha256salted_encoder'), 'Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Applications/MAMP/htdocs/symfony/app/cache/pro_/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Applications/MAMP/htdocs/symfony/app/cache/pro_/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/MAMP/htdocs/symfony/src/BugTracker/SampleBundle/Resources/views', 'BugTrackerSample');
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Applications/MAMP/htdocs/symfony/app/cache/pro_');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/symfony/app/cache/pro_',
            ...
            'kernel.bundles' => array(
                ...
                'BugTrackerSampleBundle' => 'BugTracker\\SampleBundle\\BugTrackerSampleBundle',
            ...
            'session.save_path' => '/Applications/MAMP/htdocs/symfony/app/cache/pro_/sessions',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Applications/MAMP/htdocs/symfony/app/cache/pro_/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/Applications/MAMP/htdocs/symfony/app/cache/pro_/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Applications/MAMP/htdocs/symfony/app/cache/pro_/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/MAMP/htdocs/symfony/app/cache/pro_/doctrine/orm/Proxies',
